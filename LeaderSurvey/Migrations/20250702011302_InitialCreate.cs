        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluatorLeaderId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Surveys_Leaders_EvaluatorLeaderId",
                        column: x => x.EvaluatorLeaderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionCategoryMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionCategoryMappings_QuestionCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "QuestionCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionCategoryMappings_Questions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionCategoryMappings_CategoryId",
                table: "QuestionCategoryMappings",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionCategoryMappings_QuestionId",
                table: "QuestionCategoryMappings",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Surveys_EvaluatorLeaderId",
                table: "Surveys",
                column: "EvaluatorLeaderId");
